...
// import "react-toastify/dist/handleShow.css";
      ...
      <button
        ...
        onClick={() => {
          ...
          axios
            ...
            .then((data) => {
              setvalid(true);
              toast.success("otp sent in your mail");
            })
            .catch((err) => {
      ...
      <div className="row" style={{ height: "100vh" }}>
        ...
        <div className="col-12 col-xl-7">
          {stap ? (
            ...
            >
              <h1 className="px-4 pb-4">Sign up</h1>
              <Formik
                initialValues={{
                  referralid:
                ...
                onSubmit={async (values) => {
                  let bodyContent = {
                    ...
                    otp: values.OTP,
                    email: values.Email,
                    password: values.reenterpassword,
                    refferalBy: values.referralid,
                  };
                  let reqOptions = {
                    url: `${process.env.REACT_APP_API_URL}api/customer/register`,
                    method: "POST",
                    data: bodyContent,
                  };
                  axios
                    ...
                    <Form>
                      <div className="row px-4">
                        ...
                        <div className="col-12">
                          ...
                          {errors.Fullname && validationActive ? (
                        ...
                        <div className="col-12 col-lg-6">
                          <div class="form-floating mb-2">
                            ...
                            <span onClick={() => seteye1(!eye1)}>
                              {eye1 ? <AiFillEyeInvisible /> : <AiFillEye />}
                            </span>
                            <label for="floatingInput">
                        ...
                        <div className="col-12 col-lg-6">
                          <div class="form-floating mb-2">
                            <input
                              ...
                              id="floatingInput"
                              value={values && values.reenterpassword}
                              onChange={handleChange}
                              placeholder="Enter full name"
                            />
                            <span onClick={() => seteye2(!eye2)}>
                              {eye2 ? <AiFillEyeInvisible /> : <AiFillEye />}
                            </span>
                            <label for="floatingInput">
                              Re-enter login password
                            </label>
                          </div>
                          {errors.reenterpassword && validationActive ? (
                            <div className="error">
                              {errors.reenterpassword}
                            </div>
                          ) : null}
                        ...
                        <div className="col-12">
                          <div class="form-floating mb-3">
                            <input
                              ...
                              placeholder="Enter full name"
                            />
                            <label for="floatingInput">Enter referral id</label>
                          </div>
                          {errors.referralid && validationActive ? (
                            <div className="error">{errors.referralid}</div>
                          ) : null}
                        </div>
                        <div className="d-flex align-itams-center pt-1">
                      ...
                      <button
                        className="d-block m-auto btn"
                        onClick={() => {
                          setstap(!stap);
                        }}
                      >
                        Already have an account ?
                        <span style={{ color: "#535454" }}>Log in</span>
                      </button>
                    </Form>
                  </>
                )}
            ...
            >
              ...
              <Formik
                ...
                onSubmit={(values) => {
                  ...
                  let reqOptions = {
                    url: `${process.env.REACT_APP_API_URL}api/customer/login`,
                    method: "POST",
                    data: bodyContent,
                  };
                  axios
            ...
            <Modal.Body>
              <Formik
                ...
                onSubmit={(values) => {
                  ...
                  let reqOptions = {
                    url: `${process.env.REACT_APP_API_URL}api/customer/forget-password`,
                    method: "POST",
                    data: bodyContent,
                  };
                  axios
